...
<div ng-click="dismiss();" style="cursor: pointer; z-index: 15; border: 0pxpx solid #eee; color: #f5f5f5; text-decoration:none; font-size: 10px; position: absolute; right: 10px; top: 2px;"><p style="white-space:nowrap;"><img style="vertical-align:middle;" src="images/icons/ad_close.png"/> Close Ad</p></div>\
</div>\
  ';
  ...
  return {
      ...
      link: function ($scope) {
          ...
          $scope.go_to_ad = function(){
             if(($scope.device.os == "ios") && ($scope.interstitial.link == $rootScope.default_interstitial.link)){
